...
<%@ page
	import="java.util.*, java.sql.*, org.apache.commons.fileupload.FileItem, org.apache.commons.fileupload.disk.DiskFileItemFactory, org.apache.commons.fileupload.servlet.ServletFileUpload, java.io.File"%>
...
try {
	...
	if (foodID != null) {
		String query = "SELECT foodImage FROM food WHERE foodID=?";
		PreparedStatement pstmt = conn.prepareStatement(query);
		pstmt.setString(1, foodID);
		ResultSet rs = pstmt.executeQuery();
		if (rs.next()) {
	String currentFileName = rs.getString("foodImage");
