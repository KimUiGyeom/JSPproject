...
<%@ page import="java.util.ArrayList"
	import="dto.Food, dao.FoodRepository"%>
	...
	<div class="container">
		...
		<div id="generalFoodCarousel" class="carousel slide"
				...
				<div class="carousel-item <%=(i == 0) ? "active" : ""%>">
					<div class="row">
						...
						<div class="col-md-4">
							<div class="food-item">
								<img
									src="<%=request.getContextPath()%>/images/<%=food.getImage()%>"
			...
			<a class="carousel-control-prev" href="#generalFoodCarousel"
				...
				href="#generalFoodCarousel" role="button" data-slide="next"> <span
		...
		<div id="seasonalFoodCarousel" class="carousel slide"
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="food-item">
								<img
									src="<%=request.getContextPath()%>/images/<%=food.getImage()%>"
									alt="<%=food.getName()%>" class="food-img" width="200"
									height="200">
								<h3><%=food.getName()%></h3>
								<p>
									가격:
			...
			<a class="carousel-control-prev" href="#seasonalFoodCarousel"
				...
				class="carousel-control-prev-icon" aria-hidden="true"></span> <span
				class="sr-only">Previous</span></a> <a class="carousel-control-next"
				href="#seasonalFoodCarousel" role="button" data-slide="next"> <span
				class="carousel-control-next-icon" aria-hidden="true"></span> <span
				class="sr-only">Next</span></a>
		</div>
		...
		<div id="otherFoodCarousel" class="carousel slide"
			...
			<a class="carousel-control-prev" href="#otherFoodCarousel"
				...
				class="carousel-control-prev-icon" aria-hidden="true"></span> <span
				class="sr-only">Previous</span></a> <a class="carousel-control-next"
				href="#otherFoodCarousel" role="button" data-slide="next"> <span
				class="carousel-control-next-icon" aria-hidden="true"></span> <span
				class="sr-only">Next</span></a>
		</div>
	</div>
